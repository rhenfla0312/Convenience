...
export default {
  ...
  methods: {
    myBoardNextBtn() {
      ...
      axios({
        method: "GET",
        url: this.myBoardNextPage,
        params: {
          username : localStorage.getItem("name"),
        },
      }).then((res) => {
        console.log(res)
        this.myBoardNextPage = res.data.next
        this.myBoardDatas = this.myBoardDatas.concat(res.data.results)
      }).catch((error) => {
        console.log(error)
      })
    },
        ...
        <div class="__rightInfo">
          <div class="__data __myBoard">
            ...
            <div class="__text">
              ...
              <div class="pagenation" @click="myBoardNextBtn()">
